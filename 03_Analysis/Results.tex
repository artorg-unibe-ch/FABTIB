...
\begin{document}
	...
	\begin{frame}
		...
		\begin{table}
			...
			\begin{tabular}{l|cccccc}
				...
				Tb.Sp.SD & Not-normal & Not-equal & Permutation & <0.01 & 0.08 $\pm$ 0.01 & 0.09 $\pm$ 0.05 \\
				DA & Not-normal & Equal & Mann-Whitney & 0.86 & 1.70 $\pm$ 0.23 & 1.69 $\pm$ 0.20 \\
				CV & Not-normal & Equal & Mann-Whitney & 0.84 & 0.09 $\pm$ 0.07 & 0.09 $\pm$ 0.07 \\
			\end{tabular}}
		\end{table}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.47\linewidth]{Pictures/CV_BVTV}
			\includegraphics[width=0.4\linewidth]{Pictures/FabricElasticity_Grouped}
		\end{figure}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.75\linewidth]{Pictures/FabricElasticity_Stiffness}
		\end{figure}
	\end{frame}
