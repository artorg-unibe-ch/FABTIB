...
\begin{document}
	...
	\begin{abstract}
		...
		A comparison of the resulting exponents related to $\rho$ and DA has highlighted different trends but no important difference between T2D and control samples.
		\\[0.5em]
