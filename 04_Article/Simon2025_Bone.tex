...
\begin{document}
	...
	% Images of the excluded ROIs are available in Appendix \ref{A2}.
	...
	% \section{Excluded ROIs}\label{A2}
	% Control samples with a bone volume fraction ($\rho$) higher than 0.5 are shown in Figure \ref{FigCtrlBVTV}.
	% Figure \ref{FigT2DBVTV} shows the T2D samples with a $\rho$ > 0.5.
	% These ROIs were excluded from morphometric analysis as they don't correspond to trabecular bone.
	% The Figure \ref{FigCtrlCV} and \ref{FigT2DCV} shows the samples presenting a coefficient of variation higher than 0.263 for the control group and the T2D group, respectively.
	% Mechanical and morphology-mechanical relationship comparisons were performed without these ROIs as the violate the homogeneity assumption.
	% \\

	% \begin{figure}[h!]
	% 	\centering
	% 	\begin{subfigure}[b]{0.9\linewidth}
	% 		\includegraphics[width=\linewidth]{Ctrl_BVTV1}
	% 	\end{subfigure}
	% 	\begin{subfigure}[b]{0.9\linewidth}
	% 		\includegraphics[width=\linewidth]{Ctrl_BVTV2}
	% 	\end{subfigure}
	% 	\caption{}
	% 	\label{FigCtrlBVTV}
	% \end{figure}
	...
	% 	\centering
	% 	\begin{subfigure}[b]{0.9\linewidth}
	% 		\includegraphics[width=\linewidth]{T2D_BVTV1}
	% 	\end{subfigure}
	% 	\begin{subfigure}[b]{0.9\linewidth}
	% 		\includegraphics[width=\linewidth]{T2D_BVTV2}
	% 	\end{subfigure}
	% 	\begin{subfigure}[b]{0.9\linewidth}
	% 		\includegraphics[width=\linewidth]{T2D_BVTV3}
	% 	\end{subfigure}
	% 	\caption{}
	% 	\label{FigT2DBVTV}
	% \end{figure}
	...
	% 	\centering
	% 	\begin{subfigure}[b]{0.9\linewidth}
	% 		\includegraphics[width=\linewidth]{Ctrl_CV1}
	% 	\end{subfigure}
	% 	\begin{subfigure}[b]{0.9\linewidth}
	% 		\includegraphics[width=\linewidth]{Ctrl_CV2}
	% 	\end{subfigure}
	% 	\caption{}
	% 	\label{FigCtrlCV}
	% \end{figure}
	...
	% 	\centering
	% 	\begin{subfigure}[b]{0.9\linewidth}
	% 		\includegraphics[width=\linewidth]{T2D_CV1}
	% 	\end{subfigure}
	% 	\begin{subfigure}[b]{0.9\linewidth}
	% 		\includegraphics[width=\linewidth]{T2D_CV2}
	% 	\end{subfigure}
	% 	\begin{subfigure}[b]{0.9\linewidth}
	% 		\includegraphics[width=\linewidth]{T2D_CV3}
	% 	\end{subfigure}
	% 	\begin{subfigure}[b]{0.9\linewidth}
	% 		\includegraphics[width=\linewidth]{T2D_CV4}
	% 	\end{subfigure}
	% 	\caption{}
	% 	\label{FigT2DCV}
	% \end{figure}
